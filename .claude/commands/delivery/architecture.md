...
3. Se debe realizar en Oracle Netsuite, el formulario de transacción es `recordType:"estimate"`, se debe hacer uso de un UserEventScript o ClientScript, Api version 2.1
